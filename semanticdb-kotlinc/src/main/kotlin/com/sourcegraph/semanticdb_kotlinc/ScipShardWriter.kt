 ...
 *
 * Each Kotlin source file produces a self-contained [Scip.Index] shard containing a single
 * [Scip.Document]. Unlike the javac equivalent, kotlinc compiles each source file once per round
...
internal object ScipShardWriter {
    ...
    fun write(output: Path, shard: Scip.Index) {
