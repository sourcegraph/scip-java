...
//             ^^^^^^^^^^^^^^^^^^^^^^^^^^^^ definition com/airbnb/epoxy/EpoxyModelTouchCallback#markRecyclerViewHasSelection(). private void markRecyclerViewHasSelection(unresolved_type recyclerView)
//                                          ^^^^^^^^^^^^ reference _root_/
...
//             ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ definition com/airbnb/epoxy/EpoxyModelTouchCallback#clearRecyclerViewSelectionMarker(). private void clearRecyclerViewSelectionMarker(unresolved_type recyclerView)
//                                              ^^^^^^^^^^^^ reference _root_/
