...
//     ^^^^^^^^^^^^^^ definition com/airbnb/epoxy/EpoxySwipeCallback#onSwipeStarted(). public abstract onSwipeStarted(T model, unresolved_type itemView, int adapterPosition)
//                    ^ reference com/airbnb/epoxy/EpoxySwipeCallback#[T]
...
//     ^^^^^^^^^^^^^^^^^^^^^^ definition com/airbnb/epoxy/EpoxySwipeCallback#onSwipeProgressChanged(). public abstract onSwipeProgressChanged(T model, unresolved_type itemView, float swipeProgress, unresolved_type canvas)
//                            ^ reference com/airbnb/epoxy/EpoxySwipeCallback#[T]
...
//     ^^^^^^^^^^^^^^^ definition com/airbnb/epoxy/EpoxySwipeCallback#onSwipeReleased(). public abstract onSwipeReleased(T model, unresolved_type itemView)
//                     ^ reference com/airbnb/epoxy/EpoxySwipeCallback#[T]
...
//     ^^^^^^^^^^^^^^^^ definition com/airbnb/epoxy/EpoxySwipeCallback#onSwipeCompleted(). public abstract onSwipeCompleted(T model, unresolved_type itemView, int position, int direction)
//                      ^ reference com/airbnb/epoxy/EpoxySwipeCallback#[T]
