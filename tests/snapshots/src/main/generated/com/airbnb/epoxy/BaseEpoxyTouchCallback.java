...
//                               documentation ```java\ninterface BaseEpoxyTouchCallback<T extends EpoxyModel>\n```
//                               relationship is_reference is_implementation com/airbnb/epoxy/EpoxyDragCallback#
//                               relationship is_reference is_implementation com/airbnb/epoxy/EpoxySwipeCallback#
...
//                             relationship is_reference is_implementation com/airbnb/epoxy/EpoxyTouchHelper#DragCallbacks#getMovementFlagsForModel().
//                             relationship is_reference is_implementation com/airbnb/epoxy/EpoxyTouchHelper#SwipeCallbacks#getMovementFlagsForModel().
...
//               relationship is_reference is_implementation com/airbnb/epoxy/EpoxyModelTouchCallback#clearView().
//               relationship is_reference is_implementation com/airbnb/epoxy/EpoxyModelTouchCallback#clearView(+1).
//               relationship is_reference is_implementation com/airbnb/epoxy/EpoxyTouchHelper#DragCallbacks#clearView().
//               relationship is_reference is_implementation com/airbnb/epoxy/EpoxyTouchHelper#SwipeCallbacks#clearView().
//               ^ reference semanticdb maven . . com/airbnb/epoxy/BaseEpoxyTouchCallback#[T]
//                 ^^^^^ definition local 2
//                       documentation ```java\nT model\n```
