...
//^^^^^^ definition com/airbnb/epoxy/DiffPayload#`<init>`(). <init>(List<? extends EpoxyModel<?>> models)
//            ^^^^ reference java/util/List#
//                           ^^^^^^^^^^ reference com/airbnb/epoxy/EpoxyModel#
...
//       ^^^^^^ definition com/airbnb/epoxy/DiffPayload#`<init>`(+1). public <init>(EpoxyModel<?> changedItem)
//                   ^^^^^^^^^^ reference com/airbnb/epoxy/EpoxyModel#
