...
//^^^^^^ definition com/airbnb/epoxy/DiffPayload#`<init>`(). void <init>(List<? extends EpoxyModel<?>> models)
//            ^^^^ reference java/util/List#
//                           ^^^^^^^^^^ reference com/airbnb/epoxy/EpoxyModel#
...
//       ^^^^^^ definition com/airbnb/epoxy/DiffPayload#`<init>`(+1). public void <init>(EpoxyModel<?> changedItem)
//                   ^^^^^^^^^^ reference com/airbnb/epoxy/EpoxyModel#
