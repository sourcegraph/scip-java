...
//                             relationship is_reference is_implementation com/airbnb/epoxy/SimpleEpoxyAdapter#enableDiffing().
    if (diffHelper != null) {
...
//                                   relationship is_reference is_implementation com/airbnb/epoxy/SimpleEpoxyAdapter#notifyModelsChanged().
    if (diffHelper == null) {
//      ^^^^^^^^^^ reference semanticdb maven . . com/airbnb/epoxy/EpoxyAdapter#diffHelper.
...
//                                  relationship is_reference is_implementation com/airbnb/epoxy/SimpleEpoxyAdapter#notifyModelChanged().
//                                  ^^^^^^^^^^ reference semanticdb maven . . com/airbnb/epoxy/EpoxyModel#
//                                                ^^^^^ definition local 2
//                                                      documentation ```java\nEpoxyModel<?> model\n```
...
//                         relationship is_reference is_implementation com/airbnb/epoxy/SimpleEpoxyAdapter#addModels().
//                         ^^^^^^^^^^ reference semanticdb maven . . com/airbnb/epoxy/EpoxyModel#
//                                          ^^^^^^^^^^^ definition local 8
...
//                         documentation ```java\nprotected void addModels(Collection<? extends EpoxyModel<?>> modelsToAdd)\n```
//                         documentation  Adds the models to the end of the {@link #models} list and notifies that the items were\n inserted.\n
//                         relationship is_reference is_implementation com/airbnb/epoxy/SimpleEpoxyAdapter#addModels(+1).
//                         ^^^^^^^^^^ reference semanticdb maven jdk 11 java/util/Collection#
//                                              ^^^^^^^^^^ reference semanticdb maven . . com/airbnb/epoxy/EpoxyModel#
//                                                             ^^^^^^^^^^^ definition local 11
...
//                                 relationship is_reference is_implementation com/airbnb/epoxy/SimpleEpoxyAdapter#insertModelBefore().
//                                 ^^^^^^^^^^ reference semanticdb maven . . com/airbnb/epoxy/EpoxyModel#
//                                               ^^^^^^^^^^^^^ definition local 13
...
//                           relationship is_reference is_implementation com/airbnb/epoxy/SimpleEpoxyAdapter#removeModel().
//                           ^^^^^^^^^^ reference semanticdb maven . . com/airbnb/epoxy/EpoxyModel#
//                                         ^^^^^ definition local 20
//                                               documentation ```java\nEpoxyModel<?> model\n```
    int index = getModelPosition(model);
...
//                               relationship is_reference is_implementation com/airbnb/epoxy/SimpleEpoxyAdapter#removeAllModels().
...
//                         relationship is_reference is_implementation com/airbnb/epoxy/SimpleEpoxyAdapter#showModel().
//                         ^^^^^^^^^^ reference semanticdb maven . . com/airbnb/epoxy/EpoxyModel#
//                                       ^^^^^ definition local 27
//                                             documentation ```java\nEpoxyModel<?> model\n```
//                                                      ^^^^ definition local 28
...
//                         relationship is_reference is_implementation com/airbnb/epoxy/SimpleEpoxyAdapter#showModel(+1).
//                         ^^^^^^^^^^ reference semanticdb maven . . com/airbnb/epoxy/EpoxyModel#
//                                       ^^^^^ definition local 29
//                                             documentation ```java\nEpoxyModel<?> model\n```
...
//                          relationship is_reference is_implementation com/airbnb/epoxy/SimpleEpoxyAdapter#showModels().
//                          ^^^^^^^^^^ reference semanticdb maven . . com/airbnb/epoxy/EpoxyModel#
//                                           ^^^^^^ definition local 30
//                                                  documentation ```java\nEpoxyModel<?>[] models\n```
...
//                          relationship is_reference is_implementation com/airbnb/epoxy/SimpleEpoxyAdapter#showModels(+1).
//                                  ^^^^ definition local 31
//                                       documentation ```java\nboolean show\n```
//                                        ^^^^^^^^^^ reference semanticdb maven . . com/airbnb/epoxy/EpoxyModel#
//                                                         ^^^^^^ definition local 32
...
//                          documentation ```java\nprotected void showModels(Iterable<EpoxyModel<?>> models)\n```
//                          documentation  Shows the given models, and notifies that each item changed if the item wasn't already shown.\n\n @param models The models to show. They should already be added to the {@link #models} list.\n
//                          relationship is_reference is_implementation com/airbnb/epoxy/SimpleEpoxyAdapter#showModels(+2).
...
//                          documentation ```java\nprotected void showModels(Iterable<EpoxyModel<?>> models, boolean show)\n```
//                          documentation  Sets the visibility of the given models, and notifies that the items changed if the new\n visibility is different from the previous.\n\n @param models The models to show. They should already be added to the {@link #models} list.\n @param show   True to show the models, false to hide them.\n
//                          relationship is_reference is_implementation com/airbnb/epoxy/SimpleEpoxyAdapter#showModels(+3).
//                          ^^^^^^^^ reference semanticdb maven jdk 11 java/lang/Iterable#
//                                   ^^^^^^^^^^ reference semanticdb maven . . com/airbnb/epoxy/EpoxyModel#
//                                                  ^^^^^^ definition local 34
//                                                         documentation ```java\nIterable<EpoxyModel<?>> models\n```
...
//                         relationship is_reference is_implementation com/airbnb/epoxy/SimpleEpoxyAdapter#hideModel().
//                         ^^^^^^^^^^ reference semanticdb maven . . com/airbnb/epoxy/EpoxyModel#
//                                       ^^^^^ definition local 37
//                                             documentation ```java\nEpoxyModel<?> model\n```
...
//                          relationship is_reference is_implementation com/airbnb/epoxy/SimpleEpoxyAdapter#hideModels().
//                          ^^^^^^^^ reference semanticdb maven jdk 11 java/lang/Iterable#
//                                   ^^^^^^^^^^ reference semanticdb maven . . com/airbnb/epoxy/EpoxyModel#
//                                                  ^^^^^^ definition local 38
//                                                         documentation ```java\nIterable<EpoxyModel<?>> models\n```
...
//                          documentation ```java\nprotected void hideModels(EpoxyModel<?>[] models)\n```
//                          documentation  Hides the given models, and notifies that each item changed if the item wasn't already hidden.\n\n @param models The models to hide. They should already be added to the {@link #models} list.\n
//                          relationship is_reference is_implementation com/airbnb/epoxy/SimpleEpoxyAdapter#hideModels(+1).
//                          ^^^^^^^^^^ reference semanticdb maven . . com/airbnb/epoxy/EpoxyModel#
//                                           ^^^^^^ definition local 39
//                                                  documentation ```java\nEpoxyModel<?>[] models\n```
...
//                                 relationship is_reference is_implementation com/airbnb/epoxy/SimpleEpoxyAdapter#hideAllAfterModel().
//                                 ^^^^^^^^^^ reference semanticdb maven . . com/airbnb/epoxy/EpoxyModel#
//                                               ^^^^^ definition local 40
//                                                     documentation ```java\nEpoxyModel<?> model\n```
...
//                                                relationship is_reference is_implementation com/airbnb/epoxy/SimpleEpoxyAdapter#getAllModelsAfter().
//                                                ^^^^^^^^^^ reference semanticdb maven . . com/airbnb/epoxy/EpoxyModel#
//                                                              ^^^^^ definition local 41
//                                                                    documentation ```java\nEpoxyModel<?> model\n```
    int index = getModelPosition(model);
