...
//             ^^^^^^^^^^^^^^^^^^^^^ definition com/airbnb/epoxy/preload/PreloadTargetProvider#
//             ^^^^^^^^^^^^^^^^^^^^^ definition com/airbnb/epoxy/preload/PreloadTargetProvider#`<init>`().
//                                   ^ definition com/airbnb/epoxy/preload/PreloadTargetProvider#[P]
//                                       ^^^^^^^^^^^^^^^^^^^^ reference com/airbnb/epoxy/preload/PreloadRequestHolder#
    maxPreload: Int,
//  ^^^^^^^^^^ definition com/airbnb/epoxy/preload/PreloadTargetProvider#`<init>`().(maxPreload)
//              ^^^ reference kotlin/Int#
    requestHolderFactory: () -> P
//  ^^^^^^^^^^^^^^^^^^^^ definition com/airbnb/epoxy/preload/PreloadTargetProvider#`<init>`().(requestHolderFactory)
...
//              ^^^^^ definition com/airbnb/epoxy/preload/PreloadTargetProvider#queue.
//              ^^^^^ definition com/airbnb/epoxy/preload/PreloadTargetProvider#getQueue().
...
//                                                               ^^^^^^^^^^^^^^^^^^^^ reference com/airbnb/epoxy/preload/PreloadTargetProvider#`<init>`().(requestHolderFactory)
    ...
    internal fun next(): P {
//               ^^^^ definition com/airbnb/epoxy/preload/PreloadTargetProvider#next().
//                       ^ reference com/airbnb/epoxy/preload/PreloadTargetProvider#[P]
...
//             ^^^^^^ reference local0
    ...
    fun clearAll() {
//      ^^^^^^^^ definition com/airbnb/epoxy/preload/PreloadTargetProvider#clearAll().
...
//        ^^^^^^^^^^^^^^^^^^^^ definition com/airbnb/epoxy/preload/PreloadRequestHolder#
    /** Clear any ongoing preload request. */
    fun clear()
//      ^^^^^ definition com/airbnb/epoxy/preload/PreloadRequestHolder#clear().
}
