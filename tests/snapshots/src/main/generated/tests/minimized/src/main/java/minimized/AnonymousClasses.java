...
//                               kind Method
//                               relationship is_reference is_implementation semanticdb maven jdk . java/util/function/Function#apply().
//                               ^^^^^^^ reference semanticdb maven jdk . java/lang/Integer#
//                                       ^^^^^^^ definition local 4
...
//         ⌃ enclosing_range_end local 1
      ...
      return fn.apply(n);
//           ^^ reference local 1
//              ^^^^^ reference semanticdb maven jdk . java/util/function/Function#apply().
//                    ^ reference local 0
    }
