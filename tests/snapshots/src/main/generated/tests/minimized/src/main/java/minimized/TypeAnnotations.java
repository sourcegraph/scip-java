...
// ^^^^^ reference semanticdb maven jdk N java/lang/annotation/Target#
//          ^^^^^^^^^^^ reference semanticdb maven jdk N java/lang/annotation/ElementType#
//                      ^^^^^^^^ reference semanticdb maven jdk N java/lang/annotation/ElementType#TYPE_USE.
...
//                                               ^^^^^^ reference semanticdb maven jdk N java/lang/Number#
...
//                        ^^^^^^^^^^^^^^ reference semanticdb maven . . minimized/TypeAnnotation#
//                                       ^^^^^^ reference semanticdb maven jdk N java/lang/String#
//                                       ^^^^^^ reference semanticdb maven jdk N java/lang/String#`<init>`().
