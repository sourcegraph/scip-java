...
//                         ^^^^^^^^^^^ reference semanticdb maven jdk . java/lang/reflect/Constructor#
  import java.lang.reflect.InvocationHandler;
//       ^^^^ reference semanticdb maven . . java/
//            ^^^^ reference semanticdb maven . . java/lang/
//                 ^^^^^^^ reference semanticdb maven . . java/lang/reflect/
//                         ^^^^^^^^^^^^^^^^^ reference semanticdb maven jdk . java/lang/reflect/InvocationHandler#
  import java.util.concurrent.ConcurrentHashMap;
//       ^^^^ reference semanticdb maven . . java/
//            ^^^^ reference semanticdb maven . . java/util/
//                 ^^^^^^^^^^ reference semanticdb maven . . java/util/concurrent/
//                            ^^^^^^^^^^^^^^^^^ reference semanticdb maven jdk . java/util/concurrent/ConcurrentHashMap#
  import java.util.concurrent.ConcurrentMap;
//       ^^^^ reference semanticdb maven . . java/
//            ^^^^ reference semanticdb maven . . java/util/
//                 ^^^^^^^^^^ reference semanticdb maven . . java/util/concurrent/
//                            ^^^^^^^^^^^^^ reference semanticdb maven jdk . java/util/concurrent/ConcurrentMap#
  import java.util.function.Function;
//       ^^^^ reference semanticdb maven . . java/
//            ^^^^ reference semanticdb maven . . java/util/
//                 ^^^^^^^^ reference semanticdb maven . . java/util/function/
//                          ^^^^^^^^ reference semanticdb maven jdk . java/util/function/Function#
...
//                                ^^^^^ reference semanticdb maven jdk . java/lang/Class#
//                                      ^ reference semanticdb maven . . minimized/AnnotationsOnParameterizedTypes#adapter().[C]
//                                         ^^^^^^^^ definition local 0
...
//                                                                    kind Field
//                                                                          ^^^^^^^^^^^^^^^^^ reference semanticdb maven jdk . java/util/concurrent/ConcurrentHashMap#`<init>`().
...
//           ^^^ reference semanticdb maven jdk . java/lang/System#out.
//               ^^^^^^^ reference semanticdb maven jdk . java/io/PrintStream#println(+9).
//                       ^^^^^^^^^^^ reference local 4
...
//                                                                    ^^^^^^^^^^^^^^^ reference semanticdb maven jdk . java/util/concurrent/ConcurrentMap#computeIfAbsent().
//                                                                                    ^^^^^^^^ reference local 5
//                                                                                              ^ definition local 7
//                                                                                                display_name c
