...
//                         ^^^^^^^^^^^ reference semanticdb maven jdk N java/lang/reflect/Constructor#
  import java.lang.reflect.InvocationHandler;
//       ^^^^ reference semanticdb maven . . java/
//            ^^^^ reference semanticdb maven . . java/lang/
//                 ^^^^^^^ reference semanticdb maven . . java/lang/reflect/
//                         ^^^^^^^^^^^^^^^^^ reference semanticdb maven jdk N java/lang/reflect/InvocationHandler#
  import java.util.concurrent.ConcurrentHashMap;
//       ^^^^ reference semanticdb maven . . java/
//            ^^^^ reference semanticdb maven . . java/util/
//                 ^^^^^^^^^^ reference semanticdb maven . . java/util/concurrent/
//                            ^^^^^^^^^^^^^^^^^ reference semanticdb maven jdk N java/util/concurrent/ConcurrentHashMap#
  import java.util.concurrent.ConcurrentMap;
//       ^^^^ reference semanticdb maven . . java/
//            ^^^^ reference semanticdb maven . . java/util/
//                 ^^^^^^^^^^ reference semanticdb maven . . java/util/concurrent/
//                            ^^^^^^^^^^^^^ reference semanticdb maven jdk N java/util/concurrent/ConcurrentMap#
...
//                                ^^^^^ reference semanticdb maven jdk N java/lang/Class#
//                                      ^ reference semanticdb maven . . minimized/AnnotationsOnParameterizedTypes#adapter().[C]
//                                         ^^^^^^^^ definition local 0
...
//                                                                    kind Field
//                                                                          ^^^^^^^^^^^^^^^^^ reference semanticdb maven jdk N java/util/concurrent/ConcurrentHashMap#`<init>`().
...
//                                                                    ^^^^^^^^^^^^^^^ reference semanticdb maven jdk N java/util/concurrent/ConcurrentMap#computeIfAbsent().
//                                                                                    ^^^^^^^^ reference local 5
//                                                                                              ^ definition local 7
//                                                                                                display_name c
