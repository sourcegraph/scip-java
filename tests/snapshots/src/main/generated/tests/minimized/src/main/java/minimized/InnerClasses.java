...
//                                                    ^^^^^^^ reference semanticdb maven jdk . java/lang/Integer#
//                                                             ^^^^^^^ reference semanticdb maven jdk . java/lang/Integer#
...
//                 ^^^^^^^ reference semanticdb maven jdk . java/io/PrintStream#println(+3).
//                         ^^^^^ reference semanticdb maven . . minimized/InnerClasses#InnerClass#field.
//                                 ^^^^^^^^^^^^ reference semanticdb maven . . minimized/InnerClasses#exampleField.
      }
...
//        ^^^^^^ reference semanticdb maven jdk . java/lang/System#
//               ^^^^^^^^ reference semanticdb maven jdk . java/lang/System#nanoTime().
//                            ^^^^^^ reference semanticdb maven jdk . java/lang/System#
//                                   ^^^^^^^^^^^^^^^^^ reference semanticdb maven jdk . java/lang/System#currentTimeMillis().
...
//        ^^^^^^ reference semanticdb maven jdk . java/lang/System#
//               ^^^ reference semanticdb maven jdk . java/lang/System#out.
//                   ^^^^^^^ reference semanticdb maven jdk . java/io/PrintStream#println(+8).
          break;
        case A:
