...
//⌄ enclosing_range_start scip-java maven . . minimized/Hello#HelloBuilder#`<init>`().
...
//⌄ enclosing_range_start scip-java maven . . minimized/Hello#`<init>`().
...
//                kind Class
//                definition scip-java maven . . minimized/Hello#HelloBuilder#`<init>`(). 1:11
//                display_name <init>
//                signature_documentation java @SuppressWarnings("all")\nHelloBuilder()
//                kind Constructor
//                reference scip-java maven . . minimized/Hello#HelloBuilder#`<init>`(). 1:11
//              ⌃ enclosing_range_end scip-java maven . . minimized/Hello#HelloBuilder#
//              ⌃ enclosing_range_end scip-java maven . . minimized/Hello#HelloBuilder#`<init>`().
...
//              ⌃ enclosing_range_end scip-java maven . . minimized/Hello#`<init>`().
...
//            kind Class
//      ^^^^^ definition scip-java maven . . minimized/Hello#`<init>`().
//            display_name <init>
...
//                         enclosing_symbol scip-java maven . . minimized/Hello#`<init>`().
//                 ^^^^^^^ definition local 1
//                         display_name message
//                         signature_documentation java final String message
