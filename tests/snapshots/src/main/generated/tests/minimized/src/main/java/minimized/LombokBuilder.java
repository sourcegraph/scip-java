...
@lombok.Builder
//^^^^^ definition semanticdb maven . . minimized/Hello#HelloBuilder#build().
...
//^^^^^^^^ definition semanticdb maven . . minimized/Hello#HelloBuilder#toString().
...
//^^^^^^^^^^^^^^^ reference semanticdb maven . . java/
//^^^^^^^^^^^^^^^ reference semanticdb maven . . minimized/Hello#
//^^^^^^^^^^^^^ reference semanticdb maven jdk 11 java/lang/SuppressWarnings# 1:1
//^^^^^^^^^^^^^ reference semanticdb maven jdk 11 java/lang/SuppressWarnings# 1:1
//^^^^^^^^^^^^^ reference semanticdb maven jdk 11 java/lang/SuppressWarnings# 1:1
//^^^^^^^^^^^^^ reference semanticdb maven jdk 11 java/lang/SuppressWarnings# 1:1
//^^^^^^^^^^^^^ reference semanticdb maven jdk 11 java/lang/SuppressWarnings# 1:1
