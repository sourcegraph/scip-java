...
//                 ^^^^^^ reference semanticdb maven jdk N java/util/Arrays#
  import java.util.stream.Collectors;
//       ^^^^ reference semanticdb maven . . java/
//            ^^^^ reference semanticdb maven . . java/util/
//                 ^^^^^^ reference semanticdb maven . . java/util/stream/
//                        ^^^^^^^^^^ reference semanticdb maven jdk N java/util/stream/Collectors#
...
//               kind Variable
//                 ^^^^^^ reference semanticdb maven jdk N java/util/Arrays#
//                        ^^^^^^ reference semanticdb maven jdk N java/util/Arrays#stream().
//                               ^^^^^^ reference semanticdb maven . . minimized/Enums#values().
//                                         ^^^ reference semanticdb maven jdk N java/util/stream/Stream#map().
//                                             ^ definition local 3
//                                               display_name e
...
//                                                                               ^^^^^^^ reference semanticdb maven jdk N java/util/stream/Stream#collect(+1).
//                                                                                       ^^^^^^^^^^ reference semanticdb maven jdk N java/util/stream/Collectors#
//                                                                                                  ^^^^^^ reference semanticdb maven jdk N java/util/stream/Collectors#toList().
