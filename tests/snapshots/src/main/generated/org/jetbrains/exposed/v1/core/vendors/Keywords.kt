...
//                   display_name VENDORS_KEYWORDS
//                   documentation ```kotlin\npublic final val VENDORS_KEYWORDS: Map<String, List<String>>\n```\n\n----\n\n Returns a map of vendor specific keywords.
//  ^^^^^^^^^^^^^^^^ definition semanticdb maven . . org/jetbrains/exposed/v1/core/vendors/getVENDORS_KEYWORDS().
//                   display_name VENDORS_KEYWORDS
//                   documentation ```kotlin\npublic get(): Map<String, List<String>>\n```\n\n----\n\n Returns a map of vendor specific keywords.
...
//                         display_name ANSI_SQL_2003_KEYWORDS
//                         documentation ```kotlin\npublic final val ANSI_SQL_2003_KEYWORDS: Set<String>\n```\n\n----\n\n Returns a set with all the keywords that are part of the SQL:2003 standard.
//  ^^^^^^^^^^^^^^^^^^^^^^ definition semanticdb maven . . org/jetbrains/exposed/v1/core/vendors/getANSI_SQL_2003_KEYWORDS().
//                         display_name ANSI_SQL_2003_KEYWORDS
//                         documentation ```kotlin\npublic get(): Set<String>\n```\n\n----\n\n Returns a set with all the keywords that are part of the SQL:2003 standard.
//                          ^^^^^^^^^^^ reference semanticdb maven . . kotlin/collections/Set#
//                                        ^^^^^ reference semanticdb maven . . kotlin/collections/setOf(+1).
    "A",
    "ABS",
    "ABSOLUTE",
    "ACTION",
