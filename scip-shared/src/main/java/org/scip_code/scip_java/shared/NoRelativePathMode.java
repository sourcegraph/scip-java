...
/**
 * Configuration options to determine how scip-javac should handle files that have no good relative
 * paths.
 *
 * <p>When indexing a file at an absolute path /project/src/main/example/Foo.java, SCIP needs to
 * know the "sourceroot" path /project in order to relativize the path of the source file into
...
public enum NoRelativePathMode {
  ...
  /**
   * Come up with a unique relative path for the SCIP path with no guarantee that this path
