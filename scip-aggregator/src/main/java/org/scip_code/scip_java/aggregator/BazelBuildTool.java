...
import org.scip_code.scip_java.aggregator.bazel.Bazelbuild;
...
public class BazelBuildTool {
  ...
  public static int runAndReturnExitCode(String[] args) throws IOException, InterruptedException {
    ...
    ScipAggregatorReporter reporter =
        new ScipAggregatorReporter() {
          ...
          public void error(String message) {
            System.err.println("ERROR[scip-aggregator]: " + message);
            hasErrors = true;
          }
    ...
    ScipAggregatorOptions scipOptions =
        new ScipAggregatorOptions(
            options.targetroots,
            options.output,
            options.sourceroot,
            reporter,
