...
public class BazelOptions {
  ...
  public static void printHelp() {
    System.out.println("bazel run @scip_java//scip-aggregator:bazel -- [..options]");
    System.out.println();
  ...
  public static void visitParamsFile(Path paramsFile, BazelOptions options) throws IOException {
    ...
    Optional<String> scipPlugin =
        lines.stream().filter(line -> line.startsWith("-Xplugin:scip")).findFirst();
    if (scipPlugin.isPresent()) {
