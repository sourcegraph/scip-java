              ...
              if (!args.asScala.exists(_.startsWith("-Xplugin:semanticdb"))) {
                args.addAll(
                  List(
                    ...
                    s"-Xplugin:semanticdb -targetroot:$targetRoot -sourceroot:$sourceRoot -randomtimestamp=${System
                        .nanoTime()}"
                  ).asJava
                )
              }
      ...
      if (project.getPlugins().hasPlugin("scala")) {
        ...
        project
          ...
          .configureEach { task =>
            ...
            val semanticdbVersion = BuildInfo.semanticdbScalacVersions(
              scalaVersion
            )
            ...
            val args = List(
              ...
              s"-P:semanticdb:exclude:(src/play/twirl|src/play/routes|src/${System
                  .currentTimeMillis()})", // Ignore autogenerated Playframework files
