...
//                    > public class Fields
//             ^^^^^^ definition scip-java maven . . minimized/Fields#`<init>`().
//                    kind Constructor
//                    display_name <init>
//                    signature_documentation
//                    > public Fields()
...
//                           signature_documentation
//                           > public class InnerFields
//               ^^^^^^^^^^^ definition scip-java maven . . minimized/Fields#InnerFields#`<init>`().
//                           kind Constructor
//                           display_name <init>
//                           signature_documentation
//                           > public InnerFields()
...
//                                        signature_documentation
//                                        > public static class InnerStaticFields
//                      ^^^^^^^^^^^^^^^^^ definition scip-java maven . . minimized/Fields#InnerStaticFields#`<init>`().
//                                        kind Constructor
//                                        display_name <init>
//                                        signature_documentation
...
//                  signature_documentation
//                  > Fields fields
//                        ^^^^^^ reference scip-java maven . . minimized/Fields#`<init>`().
...
//                              ^^^^^^ reference local 0
//                                         ^^^^^^^^^^^ reference scip-java maven . . minimized/Fields#InnerFields#`<init>`().
