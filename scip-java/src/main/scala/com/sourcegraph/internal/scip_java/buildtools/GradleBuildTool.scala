package com.sourcegraph.internal.scip_java.buildtools
...
import com.sourcegraph.internal.scip_java.Embedded
  ...
  private def initScript(tmp: Path): Path = {
    ...
    val script =
      s"""
         ...
         | }
         |
         | import com.sourcegraph.internal.gradle.semanticdb.SemanticdbGradlePlugin
         |
         | allprojects {
