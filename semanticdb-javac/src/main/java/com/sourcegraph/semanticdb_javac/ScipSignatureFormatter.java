...
/**
 * Formats a Java {@link Element} as a declaration string for SCIP's {@code
 * SymbolInformation.signature_documentation.text}, running directly over javac's element and
 * type-mirror APIs.
 */
