...
import com.sourcegraph.internal.semanticdb_javac.Semanticdb.SymbolInformation;
import com.sourcegraph.internal.semanticdb_javac.Semanticdb.SymbolOccurrence;
...
import com.sourcegraph.internal.Scip;
  ...
  private void processTypedDocument(
    ...
    for (ScipTextDocument doc : parseTextDocument(path).collect(Collectors.toList())) {
      ...
      for (SymbolInformation info : doc.semanticdb.getSymbolsList()) {
        ...
        // https://github.com/sourcegraph/sourcegraph/issues/50927 is
        // fixed.
